...
namespace VectorScale.Integration.Tests;
...
public class SearchEndpointTests : IAsyncLifetime
{
    ...
    public async Task InitializeAsync()
    {
        ...
        _factory = new WebApplicationFactory<Program>()
            ...
            {
                builder.UseSetting("VectorScale:Redis:ConnectionString", _redis.GetConnectionString());
                builder.UseSetting("VectorScale:SidecarGrpcAddress", "http://localhost:50051");
...
internal class StubSearchService : ISearchService
{
    ...
    public async Task<SearchResponse> SearchAsync(
        VectorScale.Api.Models.SearchRequest request,
