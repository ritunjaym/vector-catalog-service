namespace VectorScale.Api.Configuration;

public class VectorScaleOptions
{
    public const string SectionName = "VectorScale";
...
public class StorageOptions
{
    ...
    public string BucketName { get; set; } = "vectorscale";
    public string AdlsGen2Endpoint { get; set; } = "";
    public string AdlsGen2AccountName { get; set; } = "";
    public string AdlsGen2FileSystem { get; set; } = "vectorscale";
}
